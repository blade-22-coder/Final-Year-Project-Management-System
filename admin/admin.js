...
async function initAdminDashboard() {
        ...
        try {
            ...
            students.forEach((s, idx) => {
                ...
                row.querySelector(".view-btn").addEventListener("click", () => {
                    ...
                    document.getElementById("viewProjectTitle").textContent = s.projectTitle || "-";
                ...
                row.querySelector(".edit-btn").addEventListener("click", () => {
                    ...
                    document.getElementById("editFullName").value = s.user?.fullName || "";
                    document.getElementById("editEmail").value = s.user?.email || "";
                    document.getElementById("editRegistrationNumber").value = s.registrationNumber || "";
                    document.getElementById("editProjectTitle").value = s.projectTitle || "";
    ...
    document.getElementById("saveEdit").addEventListener("click", async () => {
        ...
        const res = await fetch(`${API_URL}/admin/students/${selectedStudentId}`, {
            method: "PUT",
            headers: {
